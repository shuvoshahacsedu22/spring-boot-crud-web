...
<head>
    ...
    <title>Delete Form Submission</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
</head>
<body>
<h1>
    Delete Employee Information Table

</h1>

<div class="container">
    <p id="myParagraph_errorComment1" style="color: red"></p>
</div>

<form:form  method="POST" action="/employeeDeleteForm" modelAttribute="employee">
<form:label path="employeeId">Employee Id</form:label>
<form:input id="myTextBoxes_employeeId" path="employeeId" placeholder="Employee Id" onkeyup="fetchData(1)"/>
<p>
